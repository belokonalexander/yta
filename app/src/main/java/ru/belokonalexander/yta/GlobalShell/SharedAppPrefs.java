...
public class SharedAppPrefs {
    ...
    public void setLanguage(CurrentLanguage currentLanguage){
    ...
    public CurrentLanguage getLanguage(){
       ...
       return new CurrentLanguage(sharedPreferences.getString(_LANGUAGE_FROM,"ru"),sharedPreferences.getString(_LANGUAGE_FROM_DESC,"Русский"),
