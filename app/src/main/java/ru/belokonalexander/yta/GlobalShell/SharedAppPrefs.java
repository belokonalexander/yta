 ...
 * последний перевод не сохраняется, т.к для этого есть история переводов (как по мне, удобнее, когда при открытии приложения можно сразу вводить слово, не затирая предыдущий результат)
 */
